...
class DBWNode(object):
    ...
    def twist_cb(self, twiststamped):
      if not self.enabled:
        return
      self.linear_velocity = twiststamped.twist.linear.x
      self.angular_velocity = twiststamped.twist.angular.z
      pass
    ...
    def loop(self):
        rate = rospy.Rate(1./self.frequency) # 50Hz
